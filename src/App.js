  ...
  return (
    <Canvas shadows camera={{ position: [30, 0, -3], fov: 35, near: 1, far: 50 }}>
      ...
      <Aquarium position={[0, 0.25, 0]}>
        <Float rotationIntensity={3} floatIntensity={5} speed={2}>
          <Turtle position={[0, -0.5, -1]} rotation={[0, Math.PI, 0]} scale={24} />
        </Float>
...
function Sphere({ position, scale = 5, speed = 0.1, color = 'white' }) {
  return (
    <Float rotationIntensity={40} floatIntensity={80} speed={speed / 2}>
